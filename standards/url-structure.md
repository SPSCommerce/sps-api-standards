...
- Query parameters that accept a collection of values MUST specify the collection of values by using the same query key multiple times, each with a different value.
